...
if 'name' not in st.session_state:
    st.session_state.name = "Sage BYIRINGIRO"
...
# Projects section
    ...
    testimonials = [
        "Samuel is a brilliant problem solver! His final year project was truly innovative. – Dr. Theodore",
        "Samuel's dedication to AI is inspiring. He never stops learning! – Lecture. SHIMIRWA Aline Valerie",
...
# Contact section
    ...
    st.markdown("**📧 Email:** byiringirosauf@gmail.com")
    st.markdown("[🔗 LinkedIn](https://www.linkedin.com/in/byiringiro-samuel-00060432a/)")
    st.markdown("[📂 GitHub](https://github.com/byiringirosage)")
    st.markdown("[📂 Instagram](https://www.instagram.com/sage_salute/)")
...
if page == "Testimonials":
    ...
    st.write("**Samuel is a brilliant problem solver! His final year project is truly innovative. – Mclement**")
